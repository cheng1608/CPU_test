...
HD_PWD='D:/Xilinx/VivadoProject/task4/task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPU_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCPU_TOP.tcl
