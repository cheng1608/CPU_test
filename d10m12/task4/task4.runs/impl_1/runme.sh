...
HD_PWD='D:/Xilinx/VivadoProject/task4/task4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPU_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SCPU_TOP.tcl -notrace
